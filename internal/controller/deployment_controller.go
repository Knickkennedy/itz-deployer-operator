...
const (
	...
	gitBaseOrgURL = "https://github.com/knickkennedy"
...
func (r *DeploymentReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	repoDir, err := r.cloneRepo(ctx, gitRepoURL, deployment.Spec.Release)
	if err != nil {
...
func (r *DeploymentReconciler) cloneRepo(ctx context.Context, repoName, release string) (string, error) {
	logger := logf.FromContext(ctx)
